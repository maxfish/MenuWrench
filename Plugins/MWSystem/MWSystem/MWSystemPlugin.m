...
- (void)_createMenuItem {
    ...
    NSMenuItem *m2 = [_submenu addItemWithTitle:@"Defaults" action:nil keyEquivalent:@""];
    ...
    NSMenuItem *cleanItem = [_submenu addItemWithTitle:@"Clean up 'Open with' associations" action:@selector(cleanOpenWithAssociations:) keyEquivalent:@""];
