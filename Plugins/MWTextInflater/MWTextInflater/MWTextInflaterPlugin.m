...
@interface MWTextInflaterPlugin ()
...
@implementation MWTextInflaterPlugin {
    id _keyMonitorId;
    Trie *_trie;
...
- (void)_loadSnippetFiles {
    ...
    for (NSString *fileName in filesList) {
        ...
        NSMenuItem *item = [self addMenuItemWithTitle:menuTitle toMenu:_submenu target:self action:nil];
